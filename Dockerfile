...
LABEL \
  org.opencontainers.image.authors="Ben Hankins & Christine Samarchi" \
  org.opencontainers.image.vendor="ReactJS" \
  org.opencontainers.image.url="local" \
  org.opencontainers.image.source="https://github.ibm.com/Christine-Samarchi/item-file-frontend" \
  org.opencontainers.image.version="$VERSION" \
  org.opencontainers.image.revision="$REVISION" \
  vendor="ReactJS" \
  name="item-file-frontend" \
